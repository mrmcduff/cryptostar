...
contract StarNotary is ERC721 {
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory) {
        // This returns an empty string if the value hasn't been mapped, and it's better
        // to check that value in Javascript.
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == owner1 || msg.sender == owner2, 'Only an owner can exchange a star');
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == starOwner, 'Only the owner can transfer a star');
